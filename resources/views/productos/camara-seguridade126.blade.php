...
@section('titulo', 'Cámara de Seguridad LUO E126')
    ...
    <div class="row mb-5">
        ...
        <div class="col-md-5">
            <div class="card p-3 text-center">
                <img src="{{ asset('images/img-products/camara-luo-e126.png') }}" class="img-fluid rounded imagen-contenida" alt="Cámara LUO E107">
            </div>
        </div>

        <div class="col-md-4">
            <span class="badge bg-success mb-2">MÁS VENDIDO</span>
            <h1 class="fs-4 fw-bold">Cámara de Seguridad WiFi LUO E126</h1>
        ...
        <div class="col-12">
            <div class="card4 p-4">
                ...
                <div class="border-bottom pb-3 mb-3">
                    ...
                    <p class="mt-1 mb-0">Excelente cámara, la instalé en el garage y se ve perfecto de noche. La app funciona muy bien.</p>
                </div>
                ...
                <div class="border-bottom pb-3 mb-3">
                    ...
                    <span class="text-warning">★★★★☆</span>
                    <p class="mt-1 mb-0">Muy buena relación precio-calidad. La imagen es clara y el envío llegó rápido.</p>
                </div>
                ...
                <div class="border-bottom pb-3 mb-3">
                    ...
                    <span class="text-warning">★★★☆☆</span>
                    <p class="mt-1 mb-0">Buena cámara pero la configuración WiFi fue un poco complicada al principio.</p>
                </div>
