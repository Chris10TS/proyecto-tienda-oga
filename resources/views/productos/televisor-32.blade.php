...
@section('titulo', 'Smart TV 32" 4K UHD Ultra Slim')
...
<div class="container mt-4">
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Smart TV 32" 4K UHD Ultra Slim</li>
        </ol>
    </nav>
    ...
    <div class="row mb-5">
        ...
        <div class="col-md-5">
            <div class="card4 p-3 text-center">
                <img src="{{ asset('images/img-products/tv-32.png') }}" class="img-fluid rounded" alt="Smart TV 32" 4K UHD Ultra Slim" style="max-height: 350px; object-fit: contain;">
            </div>
        </div>

        <div class="col-md-4">
            <span class="badge bg-success mb-2">MÁS VENDIDO</span>
            <h1 class="fs-4 fw-bold">Smart TV 32" 4K UHD Ultra Slim</h1>
            ...
            <p class="text-muted text-decoration-line-through mb-0">$450.000</p>
            <div class="d-flex align-items-center gap-2 mb-1">
                <span class="fs-2 fw-bold">$380.000</span>
