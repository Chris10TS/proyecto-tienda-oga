...
@section('titulo', 'Estufa Infrarroja')
    ...
    <div class="row mb-5">
        ...
        <div class="col-md-5">
            <div class="card4 p-3 text-center">
                <img src="{{ asset('images/img-products/estufa-infrarroja-lilliana.png') }}" class="img-fluid rounded imagen-contenida" alt="Cámara LUO E107" style="max-height: 350px; object-fit: contain;">
            </div>
        </div>
